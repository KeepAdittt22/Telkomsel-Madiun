...
use App\Http\Controllers\SettingCtrl;
...
Route::group(['middleware' => ['isUser']],function(){
    ...
    //Profile
    Route::get('/profil',[DashboardCtrl::class,'profile']);
    Route::post('/profil/save',[DashboardCtrl::class,'update']);
});
...
Route::group(['middleware' => ['isAdmin']],function(){
    ...
    //Setting
    Route::get('/setting',[SettingCtrl::class,'index']);
    Route::post('/setting/save',[SettingCtrl::class,'save']);
});
