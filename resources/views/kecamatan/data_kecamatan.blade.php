...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-tambah" onclick="clear_kecamatan()">
                    ...
                    @foreach ($kecamatan as $rsKecamatan)
                        <tr>
                            ...
                            <td style="text-align: center">
                              <a href="javascript:void(0)" class="btn btn-warning btn-flat btn-sm" data-toggle="modal" data-target="#modal-tambah" onclick="edit_kecamatan('{{ $rsKecamatan->id_kota }}','{{ $rsKecamatan->id_kecamatan }}','{{ $rsKecamatan->nm_kecamatan }}')"><i class="fa fa-edit"></i></a>
                              <a href="{{ url('kecamatan/delete/'.$rsKecamatan->id_kecamatan) }}" class="btn btn-danger btn-flat btn-sm" onclick="return confirmDelete(this)"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
    ...
    <div class="modal fade" id="modal-tambah">
        <div class="modal-dialog modal-lg" style="background-color: beige">
            <div class="modal-content">
                ...
                <form action="{{url('kecamatan/save')}}" method="post" onsubmit="showPreload()">
                    @csrf
