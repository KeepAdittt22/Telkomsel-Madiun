...
<aside class="main-sidebar sidebar-color sidebar-dark-primary elevation-4" style="background-color: #c72200 !important">
    <!-- Brand Logo -->
    <a class="brand-link" style="font-size: 15px">
      <img src="{{ asset ('dist/img/sidebar-logo.png') }}" alt="Telkomsel Logo" style="width: 60px; align-items: center ">
      Telkomsel Branch Madiun
    </a>
