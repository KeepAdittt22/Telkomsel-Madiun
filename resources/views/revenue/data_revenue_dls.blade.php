...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-tambah" onclick="clear_target_clus()">
                    ...
                    @foreach ($revenue_dls as $Revenue)
                        <tr>
                            ...
                            <td style="text-align: center">
                              <a href="javascript:void(0)" class="btn btn-warning btn-flat btn-sm" data-toggle="modal" data-target="#modal-tambah" onclick="edit_target_clus('{{ $Revenue->id_revenue }}','{{ $Revenue->id_product }}','{{ $Revenue->jml_target }}','{{ $Revenue->jml_revenue_old }}','{{ $Revenue->jml_revenue_new }}','{{ $Revenue->MoM}}','{{ $Revenue->YoY }}','{{ $Revenue->YtD }}')"><i class="fa fa-edit"></i></a>
                              <a href="{{ url('rev/hapus/delete/'.$Revenue->id_revenue) }}" class="btn btn-danger btn-flat btn-sm" onclick="return confirmDelete(this)"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
        ...
        <div class="modal-dialog modal-lg" style="background-color: beige">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h4 class="modal-title">Data Revenue Cluster</h4>
