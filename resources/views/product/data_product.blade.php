...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-tambah" onclick="clear_product()">
                ...
                @foreach ($product as $rsProduct)
                    <tr>
                        ...
                        <td style="text-align: center">
                          <a href="javascript:void(0)" class="btn btn-warning btn-flat btn-sm" data-toggle="modal" data-target="#modal-tambah" onclick="edit_product('{{ $rsProduct["id_product"] }}','{{ $rsProduct["nm_product"] }}')"><i class="fa fa-edit"></i></a>
                          <a href="{{ url('product/delete/'.$rsProduct["id_product"]) }}" class="btn btn-danger btn-flat btn-sm" onclick="return confirmDelete(this)"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    <div class="modal fade" id="modal-tambah">
        <div class="modal-dialog modal-lg" style="background-color: beige">
            <div class="modal-content">
                ...
                <form action="{{url('product/save')}}" method="post" onsubmit="showPreload()">
                    @csrf
