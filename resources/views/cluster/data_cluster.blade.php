...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <button type="button" class="btn btn-warning" data-toggle="modal"                   data-target="#modal-tambah" onclick="clear_cluster()">
            ...
            <tbody>
                @foreach ($cluster as $rsCluster)
                    <tr>
                        ...
                        <a href="javascript:void(0)" class="btn btn-warning btn-flat btn-sm" data-toggle="modal" data-target="#modal-tambah" onclick="edit_cluster('{{ $rsCluster["id_cluster"] }}','{{ $rsCluster["nm_cluster"] }}','{{ $rsCluster["kat_cluster"]}}')"><i class="fa fa-edit"></i></a>
                        <a href="{{ url('cluster/delete/'.$rsCluster["id_cluster"]) }}" class="btn btn-danger btn-flat btn-sm" onclick="return confirmDelete(this)"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    <div class="modal fade" id="modal-tambah">
        <div class="modal-dialog modal-lg" style="background-color: beige">
            <div class="modal-content">
                ...
                <form action="{{url('cluster/save')}}" method="post" onsubmit="showPreload()">
                    @csrf
