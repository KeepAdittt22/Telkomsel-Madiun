...
class KecamatanCtrl extends Controller
{
    ...
    function save(Request $req){
        ...
        try {
            ...
            //Message Success
            $mess=["type"=>"Data Kecamatan","text"=>"Berhasil Disimpan !!!","icon"=>"success","button"=>"OK"];
        } catch(Exception $err){
            //Message Error
            $mess=["type"=>"Data Kecamatan","text"=>"Gagal Disimpan !!!","icon"=>"error","button"=>"OK"];
        }
        //Redirect
    ...
    function delete(Request $req){
        try{
            ...
            //Message Success
            $mess=["type"=>"Data Kecamatan","text"=>"Berhasil Dihapus !!!","icon"=>"success","button"=>"OK"];
        } catch(Exception $err){
            //Message Error
            $mess=["type"=>"Data Kecamatan","text"=>"Gagal Dihapus !!!","icon"=>"error","button"=>"OK"];
        }
        //Redirect
        return redirect('kecamatan')->with($mess);
    }
