...
class RevenueCtrl extends Controller
{
  ...
  function detail(Request $req){
      ...
      ->first();     
        ...
        //Data Revenue
        $data=[
            "title"=>"Data Revenue Kecamatan",
            "page_title"=>"Data Revenue Kecamatan",
            "product"=>$product,
            "revenue"=>$revenue,
    ...
    function import(){
        $data=[
            "title"=>"Import Rev Kecamatan",
            "page_title"=>"Import Rev Kecamatan"
        ];
    ...
    function import_save(Request $req){
        $file = $req->file("data_revenue");
        $type = $file->getMimeType();
        if($type!="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"){
            return back()->with(["type"=>"Data Revenue Kecamatan Gagal Diimport","text"=>"Pastikan Type File .xlsx !!!","icon"=>"error","button"=>"OK"]);
        }
    ...
    //    dd($data[0]);
        ...
        //Message Success
        $mess=["type"=>"Import Revenue Kecamatan","text"=>'Selesai !!! <br/><p class="text-success mt-2 mb-0">'.$success.' Berhasil</p><p class="text-danger m-0"> '.$error.' Gagal</p>',"icon"=>"info","button"=>"OK"];
    ...
    function save(Request $req){
        ...
        try{
            ...
            //Message Success
            $mess=["type"=>"Data Revenue Kecamatan","text"=>"Berhasil Disimpan !!!","icon"=>"success","button"=>"OK"];
        } catch(Exception $err){
            //Message Error
            $mess=["type"=>"Data Revenue Kecamatan","text"=>"Gagal Disimpan !!!","icon"=>"error","button"=>"OK"];
        }
        //Redirect
        return back()->with($mess);
    }
    ...
    function delete(Request $req){
        try{
            ...
            //Message Success
            $mess=["type"=>"Data Revenue Kecamatan","text"=>"Berhasil Dihapus !!!","icon"=>"success","button"=>"OK"];
        } catch(Exception $err){
            //Message Error
            $mess=["type"=>"Data Revenue Kecamatan","text"=>"Gagal Dihapus !!!","icon"=>"error","button"=>"OK"];
        }
        //Redirect
        return back()->with($mess);
    }
    ...
    function import_dls(){
        $data=[
            "title"=>"Import Rev Cluster",
            "page_title"=>"Import Rev Cluster"
        ];
    ...
    function import_cluster(Request $req){
        $file = $req->file("data_revenue_dls");
        $type = $file->getMimeType();
        //dd($type);
        if($type!="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"){
         return back()->with(["type"=>"Data Revenue Cluster Gagal Diimport","text"=>"Pastikan Type File .xlsx !!!","icon"=>"error","button"=>"OK"]);
        }
        ...
        //Message Success
        $mess=["type"=>"Import Revenue Cluster","text"=>'Selesai !!! <br/><p class="text-success mt-2 mb-0">'.$success.' Berhasil</p><p class="text-danger m-0"> '.$error.' Gagal</p>',"icon"=>"info","button"=>"OK"];
    ...
    function save_dls(Request $req){
        ...
        try{
            ...
            //Message Success
            $mess=["type"=>"Data Revenue Cluster","text"=>"Berhasil Disimpan !!!","icon"=>"success","button"=>"OK"];
        } catch(Exception $err){
            //Message Error
            $mess=["type"=>"Data Revenue Cluster","text"=>"Gagal Disimpan !!!","icon"=>"error","button"=>"OK"];
        }
        //Redirect
        return back()->with($mess);
    }
    ...
    function deletedls(Request $req){        
        try{
            ...
            //Message Success
            $mess=["type"=>"Data Revenue Cluster","text"=>"Berhasil Dihapus !!!","icon"=>"success","button"=>"OK"];
        } catch(Exception $err){
            //Message Error
            $mess=["type"=>"Data Revenue Cluster","text"=>"Gagal Dihapus !!!","icon"=>"error","button"=>"OK"];
        }
        //Redirect
        return back()->with($mess);
    }
