...
class ClusterCtrl extends Controller
{
    ...
    function save(Request $req){
        ...
        try {
            ...
            //Message Success
            $mess=["type"=>"Data Cluster","text"=>"Berhasil Disimpan !!!","icon"=>"success","button"=>"OK"];
        } catch(Exception $err){
            //Message Error
            $mess=["type"=>"Data Cluster","text"=>"Data Gagal Disimpan !!!","icon"=>"error","button"=>"OK"];
        }
        // Redirect
    ...
    function delete(Request $req){
        try{
            ...
            //Message Success
            $mess=["type"=>"Data Cluster","text"=>"Berhasil Dihapus !!!","icon"=>"success","button"=>"OK"];
        } catch(Exception $err){
            //Message Error
            $mess=["type"=>"Data Cluster","text"=>"Gagal Dihapus !!!","icon"=>"error","button"=>"OK"];
        }
        // Redirect
        return redirect('cluster')->with($mess);
    }
