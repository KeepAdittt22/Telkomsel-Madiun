...
class KotaCtrl extends Controller
{
    ...
    function save(Request $req){
        ...
        try {
            ...
            //Message Success
            $mess=["type"=>"Data Kota","text"=>"Berhasil Disimpan !!!","icon"=>"success","button"=>"OK"];
        } catch(Exception $err){
            //Message Error
            $mess=["type"=>"Data Kota","text"=>"Gagal Disimpan !!!","icon"=>"error","button"=>"OK"];
        }
        // Redirect
    ...
    function delete(Request $req){
        try{
            ...
            //Message Success
            $mess=["type"=>"Data Kota","text"=>"Berhasil Dihapus !!!","icon"=>"success","button"=>"OK"];
        }catch(Exception $err){
            //Message Error
            $mess=["type"=>"Data Kota","text"=>"Gagal Dihapus !!!","icon"=>"error","button"=>"OK"];
        }
        //Redirect
        return redirect('kota')->with($mess);
    }
